...
public class Recipes extends RecipeProvider {
    HolderGetter<Item> itemRegistry;
    public Recipes(HolderLookup.Provider registries, RecipeOutput output) {
        super(registries,output);
        itemRegistry = registries.lookupOrThrow(Registries.ITEM);
    }
    @Override
...
/*    private void OptionalHead(RecipeOutput consumer, String name, String modid, EntityType<?> type, ResourceLocation item) {
    ...
    private ShapelessRecipeBuilder Shapeless(RecipeCategory category, Item result) {
        return ShapelessRecipeBuilder.shapeless(itemRegistry, category, result);
    }

    private ShapelessRecipeBuilder Shapeless(RecipeCategory category, Item result, int count) {
        return ShapelessRecipeBuilder.shapeless(itemRegistry, category, result, count);
    }

    private ShapedRecipeBuilder Shaped(RecipeCategory category, Item result) {
        return ShapedRecipeBuilder.shaped(itemRegistry, category, result);
    }

    private ShapedRecipeBuilder Shaped(RecipeCategory category, Item result, int count) {
        return ShapedRecipeBuilder.shaped(itemRegistry, category, result, count);
    }
