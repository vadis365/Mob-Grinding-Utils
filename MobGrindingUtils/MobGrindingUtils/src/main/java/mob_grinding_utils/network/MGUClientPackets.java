    ...
    public static void HandleChickenSync(ChickenSyncPacket message) {
        ...
        if (world == null)
            ...
            if (chicken != null) {
				...
				nbt.putBoolean("shouldExplode", message.nbt().getBoolean("shouldExplode").orElse(false));
				nbt.putInt("countDown", message.nbt().getInt("countDown").orElse(0));
				if (message.nbt().getInt("countDown").orElse(0) >= 20) {
                    for (int k = 0; k < 20; ++k) {
						...
						world.addParticle(ParticleTypes.EXPLOSION, chicken.getX() + (double) (world.getRandom().nextFloat() * chicken.getBbWidth() * 2.0F) - (double) chicken.getBbWidth(), chicken.getY() + (double) (world.getRandom().nextFloat() * chicken.getBbHeight()), chicken.getZ() + (double) (world.getRandom().nextFloat() * chicken.getBbWidth() * 2.0F) - (double) chicken.getBbWidth(), xSpeed, ySpeed, zSpeed);
						world.addParticle(ParticleTypes.LAVA, chicken.getX() + (double) (world.getRandom().nextFloat() * chicken.getBbWidth() * 2.0F) - (double) chicken.getBbWidth(), chicken.getY() + (double) (world.getRandom().nextFloat() * chicken.getBbHeight()), chicken.getZ() + (double) (world.getRandom().nextFloat() * chicken.getBbWidth() * 2.0F) - (double) chicken.getBbWidth(), xSpeed, ySpeed, zSpeed);
                    }
                }
            } else {
