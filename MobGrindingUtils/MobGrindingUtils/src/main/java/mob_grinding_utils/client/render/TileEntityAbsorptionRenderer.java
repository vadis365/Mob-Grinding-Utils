...
/*		GlStateManager.depthMask(false);
		...
		WorldRenderer.renderFilledBox(tile.getAABBForRender(), 0F, 1F, 0F, 0.75F);

*/
		WorldRenderer.drawBoundingBox(matrixStack, ivertexbuilder, tile.getAABBForRender(), 1F, 1F, 0F, 1F);
/*
