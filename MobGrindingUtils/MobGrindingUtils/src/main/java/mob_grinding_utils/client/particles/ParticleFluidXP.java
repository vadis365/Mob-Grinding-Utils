...
public class ParticleFluidXP extends SingleQuadParticle {
    ...
    public ParticleFluidXP(ClientLevel world, double x, double y, double z, double tx, double ty, double tz, int count, int color, float scale, TextureAtlasSprite sprite) {
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, RandomSource random) {
            return new ParticleFluidXP(world, x + world.getRandom().nextDouble() - 0.5D * 0.05D, y + 0.125D, z + world.getRandom().nextDouble() - 0.5D * 0.05D, xSpeed, ySpeed, zSpeed, 20, 16776960, 0.125F, sprites.get(world.getRandom()));
        }
    }
}
