...
public class ModItems {
	...
	public static RegistryObject<Item> FLUID_XP_BUCKET = ITEMS.register("fluid_xp_bucket", () -> new BucketItem(() -> ModBlocks.FLUID_XP.get(), new Item.Properties().tab(MobGrindingUtils.TAB).craftRemainder(Items.BUCKET).stacksTo(1)));
