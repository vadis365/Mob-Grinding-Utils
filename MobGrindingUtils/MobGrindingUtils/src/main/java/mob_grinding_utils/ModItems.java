...
public class ModItems {
	...
	public static DeferredItem<Item> MONOCLE = ITEMS.register("monocle", () -> new ItemMonocle(new Item.Properties().stacksTo(1).humanoidArmor(ArmorMaterials.CHAINMAIL, ArmorType.HELMET)));
