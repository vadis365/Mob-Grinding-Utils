...
public class ModTags {
    ...
    public static class Entities {
        ...
        public static final TagKey<EntityType<?>> NO_DREADFUL_SPAWN = TagKey.create(Registry.ENTITY_TYPE_REGISTRY, new ResourceLocation(Reference.MOD_NAME, "no_dreadful_spawn"));
        public static final TagKey<EntityType<?>> NO_DELIGHTFUL_SPAWN = TagKey.create(Registry.ENTITY_TYPE_REGISTRY, new ResourceLocation(Reference.MOD_NAME, "no_delightful_spawn"));
    }
