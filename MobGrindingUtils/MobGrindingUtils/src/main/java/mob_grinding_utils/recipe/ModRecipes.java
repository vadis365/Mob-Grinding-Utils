...
public class ModRecipes {
	...
	public static void init() {
		...
		//Chicken Feed
		CHICKEN_FEED = new RecipeChickenFeed().setRegistryName(getResource("chicken_feed"));
		...
		ABSORPTION_HOPPER.setRegistryName(getResource("absorption_hopper"));
		...
		ABSORPTION_UPGRADE.setRegistryName(getResource("absorption_upgrade"));
		...
		TANK_SINK.setRegistryName(getResource("tank_sink"));
		...
		FAN_UPGRADE_1.setRegistryName(getResource("fan_uprade_1"));
		...
		FAN_UPGRADE_2.setRegistryName(getResource("fan_uprade_2"));
		...
		FAN_UPGRADE_3.setRegistryName(getResource("fan_uprade_3"));
		...
		MOB_SWAB.setRegistryName(getResource("mob_swab"));
		...
		WITHER_MUFFLER.setRegistryName(getResource("wither_muffler"));
		...
		DRAGON_MUFFLER.setRegistryName(getResource("dragon_muffler"));
		...
		SAW.setRegistryName(getResource("saw"));
		...
		SAW_UPGRADE_1.setRegistryName(getResource("saw_upgrade_1"));
		...
		SAW_UPGRADE_2.setRegistryName(getResource("saw_upgrade_2"));
		...
		SAW_UPGRADE_3.setRegistryName(getResource("saw_upgrade_3"));
		...
		SAW_UPGRADE_4.setRegistryName(getResource("saw_upgrade_4"));
		...
		SAW_UPGRADE_5.setRegistryName(getResource("saw_upgrade_5"));
		...
		SAW_UPGRADE_6.setRegistryName(getResource("saw_upgrade_6"));
	}
