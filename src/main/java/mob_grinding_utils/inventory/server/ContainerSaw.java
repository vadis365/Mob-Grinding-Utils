...
public class ContainerSaw extends Container {
	...
	public ContainerSaw(EntityPlayer player, TileEntitySaw tile) {
		...
		fan = tile;
		int i = (numRows - 4) * 18;
		addSlotToContainer(new SlotRestriction(tile, 0, 18, 18, new ItemStack(ItemBlockRegister.SAW_UPGRADE, 1, 0), 10));
		addSlotToContainer(new SlotRestriction(tile, 1, 43, 18, new ItemStack(ItemBlockRegister.SAW_UPGRADE, 1, 1), 10));
		addSlotToContainer(new SlotRestriction(tile, 2, 68, 18, new ItemStack(ItemBlockRegister.SAW_UPGRADE, 1, 2), 10));
		addSlotToContainer(new SlotRestriction(tile, 3, 93, 18, new ItemStack(ItemBlockRegister.SAW_UPGRADE, 1, 3), 10));
		addSlotToContainer(new SlotRestriction(tile, 4, 118, 18, new ItemStack(ItemBlockRegister.SAW_UPGRADE, 1, 4), 10));
		addSlotToContainer(new SlotRestriction(tile, 5, 143, 18, new ItemStack(ItemBlockRegister.SAW_UPGRADE, 1, 5), 10));
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int slotIndex) {
		...
		if (slot != null && slot.getHasStack()) {
			...
			stack = stack1.copy();
			if (slotIndex > 5) {
				if (stack1.getItem() == ItemBlockRegister.SAW_UPGRADE && stack1.getItemDamage() == 0)
					if (!mergeItemStack(stack1, 0, 1, false))
						return null;
				if (stack1.getItem() == ItemBlockRegister.SAW_UPGRADE && stack1.getItemDamage() == 1)
					if (!mergeItemStack(stack1, 1, 2, false))
						return null;
				if (stack1.getItem() == ItemBlockRegister.SAW_UPGRADE && stack1.getItemDamage() == 2)
					if (!mergeItemStack(stack1, 2, 3, false))
						return null;
				if (stack1.getItem() == ItemBlockRegister.SAW_UPGRADE && stack1.getItemDamage() == 3)
					if (!mergeItemStack(stack1, 3, 4, false))
						return null;
				if (stack1.getItem() == ItemBlockRegister.SAW_UPGRADE && stack1.getItemDamage() == 4)
					if (!mergeItemStack(stack1, 4, 5, false))
						return null;
				if (stack1.getItem() == ItemBlockRegister.SAW_UPGRADE && stack1.getItemDamage() == 5)
